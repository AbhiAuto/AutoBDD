...
// Begin no need to adjust string length
...
function addCommand(command_name, command_target_array, command_value, auto, insertCommand) {
    ...
    // Begin for add new command manually
    return new_record;
    // End
}
...
function addCommandManu(command_name, command_target_array, command_value) {
    // Begin of add new command manually
    var new_record = addCommand(command_name, command_target_array, command_value, 0, false);
    // select new command
    $('#records-grid .selectedRecord').removeClass('selectedRecord');
    $(new_record).addClass('selectedRecord');
    // End
}
