        ...
        if (request.commands == "waitPreparation") {
            ...
            if (selenium["do" + upperCase] != null) {
                ...
                try {
                    ...
                    continueTestWhenConditionIsTrue(waitForCondition, sendResponse);
                } catch(e) {
                    console.error(e);
                    // Synchronous command failed
                    document.body.removeAttribute("SideeXPlayingFlag");
...
// Begin Selenium IDE
function continueTestWhenConditionIsTrue(waitForCondition, sendResponse) {
    try {
        if (waitForCondition == null) {
            ...
            setTimeout(function() {
                continueTestWhenConditionIsTrue(waitForCondition);
            }, 10);
        }
    } catch(e) {
        console.error(e);
